/*  PICO Search App
    ...
    14sep17 v1.2a -- add ability to modify header text; 
            v1.2b adds default value
    15mar18 v1.2c -- switch and doc refs to widgets.ebscohost.com
*/
...
function picoEditor() {
    ...
    jQuery('#' + pops.after).after('<li id="xboxItem" class="find-field-link"><a href="#" id="xboxAnchor" alt="Do a PICO search in EDS" title="Opens a separate form for entering a PICO expression">'+pops.label+'</a></li>');
