...
function picoEditor() {
    ...
    jQuery("#" + pops.after).after(
      '<li id="picoBoxItem" class="find-field-link"><a href="#" id="picoBoxAnchor" alt="Do a PICO search in EDS" title="Opens a separate form for entering a PICO expression">' +
        pops.label +
        "</a></li>"
    );
