...
function picoEditor() {
    ...
    pops.label = pops.label || "PICO Search",
      ...
      pops.title = pops.title || "Opens a separate form for entering a PICO expression";
    ...
    jQuery('#' + pops.after).after('<li id="picoBoxItem" class="find-field-link"><a href="#" id="picoBoxAnchor" alt="Do a PICO search in EDS">'+pops.label+'</a></li>');
...
function openPopup(name, filename, qdata) {
    ...
    var theName = name;
    var theSource = "https://widgets.ebscohost.com/prod/simplekey/picoEditor/docs/" + filename + qData;
